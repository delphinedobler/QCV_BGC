        ...
        app_ui = ui.page_fluid(  
            ...
            ui.layout_sidebar(
                ui.sidebar(
                    ...
                    ui.output_ui(id='username_output_text', class_='center'),
                    ui.div(
                        ui.HTML(f"<img src='https://cdn-icons-png.flaticon.com/512/9131/9131529.png' width='100' height='100'>"),
                        class_='center',
                    ),
                    *self.panel_sidebar,
...
class BaseServerTmpl:
    ...
    def setup_base_callbacks(self, session: Session):
        ...
        def username_output_text():
            return ui.strong(
                f"{user_workspace.username}",
                )
        
        @reactive.effect
        @reactive.event(self.input.logout_btn)
        async def logout():
            try:
